...
class listCarParkScreen extends StatefulWidget {
  final String jobID;
  final String cost_type;
  final String Job_no;
  final String commader_tel;
  const listCarParkScreen(
      this.jobID, this.cost_type, this.Job_no, this.commader_tel,
      {super.key});

  @override
  State<listCarParkScreen> createState() => _listCarParkScreenState();
}

class _listCarParkScreenState extends State<listCarParkScreen> {
          ...
          return SizedBox(
            ...
            child: Card(
              ...
              child: InkWell(
                onTap: () {
                  AppStyle().link_to(
                      costCarPark(widget.jobID, widget.Job_no,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppStyle().row_detail(
                          "ยอดรวมค่าที่จอดรถ", row["price"] + " บาท"),
                      AppStyle().row_detail(
