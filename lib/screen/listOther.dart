...
class listOtherScreen extends StatefulWidget {
  final String jobID;
  final String cost_type;
  final String Job_no;
  final String commader_tel;
  const listOtherScreen(
      this.jobID, this.cost_type, this.Job_no, this.commader_tel,
      {super.key});

  @override
  State<listOtherScreen> createState() => _listOtherScreenState();
}

class _listOtherScreenState extends State<listOtherScreen> {
  ...
  Scaffold cost(data) {
    return Scaffold(
      appBar: AppBar(
        title: Text("ข้อมูลค่าใช้จ่ายอื่นๆ"),
        actions: <Widget>[
      ...
      floatingActionButton:
        ...
        FloatingActionButton(
          onPressed: () {
            AppStyle().link_to(
                costOther(widget.jobID, widget.Job_no, widget.commader_tel, ""),
                context);
          },
          ...
          return SizedBox(
            ...
            child: Card(
              ...
              child: InkWell(
                onTap: () {
                  AppStyle().link_to(
                      costOther(widget.jobID, widget.Job_no,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppStyle()
                          .row_detail("ค่าใช้จ่ายยอด", row["price"] + " บาท"),
                      AppStyle()
                          .row_detail("รายละเอียดการซื้อจ้าง ", row["remark"]),
                      AppStyle().row_detail("สถานที่ ", row["location"]),
