...
class _summarytabScreenState extends State<summarytabScreen> {
  ...
  var _tc_wage_cost,
      ...
      _total_r_cost,
      _dr_job;
  var _dt_time, _dt_ot, _driver_name;
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              AppStyle()
                  .text("ใบงานเลขที่ : " + widget.job_no, 24, Colors.blueGrey),
              AppStyle().space_box(10),
              element_widget().row_tmp_2(
                  cardCheckup(), cardMile(dr["mile_begin"], dr["mile_end"])),
              AppStyle().space_box(10),
              cardTimeRecord(),
              AppStyle().space_box(10),
              element_widget().row_tmp_2(cardTransferCost(), cardCostReal()),
  ...
  rowTotalOT() {
    Widget w1 = Column(
      ...
      children: [
        AppStyle().text("OT 1 เท่า :", 14, Colors.deepPurple),
        AppStyle().text("OT 1.5 เท่า :", 14, Colors.deepPurple),
        AppStyle().text("OT 3 เท่า :", 14, Colors.deepPurple)
      ],
    );
    Widget w2 = Column(
    ...
    if (_is_edit) {
      return element_widget().row_tmp_3(w1, w2, w3, [3, 4, 3]);
    } else {
      return element_widget().row_tmp_3(w1, w2, Container(), [3, 4, 3]);
    }
  }
